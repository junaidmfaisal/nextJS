...
export default function Service3() {
    return (
        <section className="w-full px-4 sm:px-8 md:px-16 py-12 space-y-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-[url('/dining.png')] bg-cover bg-center px-4 sm:px-6 lg:px-12 py-10">
                {/* Mobile: Image first */}
                <motion.div
            ...
            <div className="w-full px-4 py-12 bg-[url('/bedroom-bg.png')] bg-cover bg-center">
                ...
                <motion.div
                    ...
                    viewport={{ once: true, amount: 0.3 }}
                    transition={{ duration: 0.8 }}
                    className="mt-10 max-w-4xl text-center md:text-left order-3"
                >
                    <p className="text-gray-700 leading-relaxed text-sm sm:text-base md:w-[80rem] text-justify">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-[url('/kidsroom-bg')] bg-cover bg-center px-4 sm:px-6 lg:px-12 py-10">
                {/* Mobile: Image first */}
                <motion.div
                    initial={{ opacity: 0, x: -50 }}
                    whileInView={{ opacity: 1, x: 0 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center bg-[url('/modular-kitchen-bg.png')] bg-cover bg-center px-4 sm:px-6 lg:px-12 py-10">
                {/* Mobile: Image first */}
                <motion.div
                    initial={{ opacity: 0, x: -50 }}
                    whileInView={{ opacity: 1, x: 0 }}
